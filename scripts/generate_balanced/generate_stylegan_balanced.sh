#!/bin/bash
#SBATCH --job-name=generate_stylegan_balanced
...
#SBATCH --output=/storage/DSH/projects/hardness_genai/outputs/generate_stylegan_balanced_%j.out
#SBATCH --error=/storage/DSH/projects/hardness_genai/outputs/generate_stylegan_balanced_%j.err
...
echo "Starting Balanced StyleGAN Data Generation..."

/opt/conda/bin/python generate_stylegan_balanced_cifar100.py
