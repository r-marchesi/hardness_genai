#!/bin/bash
#SBATCH --job-name=generate_edm_balanced
...
#SBATCH --output=/storage/DSH/projects/hardness_genai/outputs/generate_edm_balanced_%j.out
#SBATCH --error=/storage/DSH/projects/hardness_genai/outputs/generate_edm_balanced_%j.err
...
echo "Starting Balanced EDM Data Generation..."

python generate_edm_balanced_cifar100.py
