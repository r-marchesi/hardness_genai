...
#SBATCH --output=/storage/DSH/projects/hardness_genai/outputs/evaluate_metrics_%j.out
#SBATCH --error=/storage/DSH/projects/hardness_genai/outputs/evaluate_metrics_%j.err
...
/opt/conda/bin/pip install torch-fidelity

echo "Starting Metric Evaluation (IS & FID)..."
/opt/conda/bin/python evaluate_balanced_metrics.py
